  ...
  <div className="text-left w-full">
    <div className="" style={sectionStyle}>
      <div style={{paddingTop: "5%", paddingLeft: "10%"}}>
        ...
        <p className="text-grey-darker text-xl font-thin max-w-sm mt-8 mb-8">When everyone knows exactly what needs to be done and when, teamwork flows smoothly.</p>
